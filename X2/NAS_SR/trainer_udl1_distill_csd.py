...
class Trainer():
    def __init__(self, args, loader, my_model, my_model_teacher, my_loss, ckp):
        ...
        self.model_teacher.model.load_state_dict(torch.load('../experiment/train_teacher_f1/model/model_best.pt'), strict=True)
        self.loss = my_loss
        ...
        for batch, (lr, hr, _) in enumerate(self.loader_train):
            ...
            if isinstance(sr, list):
                ...
                # step2
                    ...
                    sr_teacher_ = torch.mul(sr_teacher, s)
                    bic_sample_ = torch.mul(bic_sample, s)

                    loss = self.loss(sr_teacher_, sr_, bic_sample_, hr_, self.contra_lambda)
