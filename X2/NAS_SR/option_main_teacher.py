...
# parser.add_argument('--chop', default=1, help='enable memory-efficient forward')
parser.add_argument('--no_augment', action='store_true',
                    help='do not use data augmentation')

# Model specifications
# parser.add_argument('--model', default='EDSR',
parser.add_argument('--model', default='model_sr_teacher',
                    help='model name')
...
parser.add_argument('--pre_train', type=str, default='../experiment/train_teacher/model/model_best.pt',
...
parser.add_argument('--tail_fea', type=int, default=12, help='pretrain epoch')
parser.add_argument('--search_n_feats', type=int, default=32, help='pretrain epoch')
parser.add_argument('--offset', type=int, default=0, help='pretrain epoch')
